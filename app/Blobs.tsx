...
const Blobs: React.FC = () => {
  ...
  return (
    <div className="absolute w-full border overflow-hidden -z-10">
      <Blob
        className="bg-[#f93d3d] w-[500px] h-[500px] blur-3xl scale-75 md:scale-100 mix-blend-multiply"
        animationName="animateBlob1"
        duration="12s"
        initialPosition={randomPosition()}
      />
      <Blob
        className="bg-[#44ee44] w-[500px] h-[500px] blur-3xl scale-75 md:scale-100 mix-blend-color"
      ...
      /> */}
      <Blob
        className="bg-[#9f46f3] w-[500px] h-[500px] blur-3xl scale-75 md:scale-100 mix-blend-color"
