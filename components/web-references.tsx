      ...
      <Credenza>
        <div className="flex flex-col gap-2 mb-4">
          <div className="flex flex-row gap-4 overflow-x-auto mt-4">
            {searchResults?.web.results.slice(0, 6).map((item: Result, index: number) => (
              <div
          ...
          <div className="flex gap-4 overflow-x-auto mt-4">
            {searchResults?.web.results.slice(0, 6).map((item: Result) => {
        ...
        <CredenzaContent className="max-h-[80vh] overflow-y-auto ">
          ...
          <div>
            {searchResults?.web.results.map((item: Result) => (
              <div
                key={item.url}
